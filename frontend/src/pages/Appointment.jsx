...
const Appointment = () => {
  ...
  while(currentDate<endTime){
    ...
    //Increment Current Time by 30 minit
  ...
  return docInfo && (
    ...
    <div className='flex flex-col sm:flex-row gap-4'>
      ...
      <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
        {/*DOc Infro name degree experiences */}
    ...
    <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
          <p>Booking slots</p>
          <din className='flex gap-3 items-center w-full overflow-x-scroll mt-4' >
            {
          ...
          <button className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6'>Book an Appointmnet</button>
    </div>
